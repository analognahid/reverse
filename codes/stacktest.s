...
0x1396:	push rbp                             
0x1397:	mov rbp, rsp                         
0x139a:	mov dword ptr [rbp - 4], edi         
0x139d:	mov dword ptr [rbp - 8], esi         
0x13a0:	mov edx, dword ptr [rbp - 4]         #    return a@b;
0x13a3:	mov eax, dword ptr [rbp - 8]         
0x13a6:	add eax, edx                         
0x13a8:	pop rbp                              #@
0x13a9:	ret                                  
0x13aa:	endbr64                              #float addf(float a, float b)@
0x13ae:	push rbp                             
0x13af:	mov rbp, rsp                         
0x13b2:	movss dword ptr [rbp - 4], xmm0      
0x13b7:	movss dword ptr [rbp - 8], xmm1      
0x13bc:	movss xmm0, dword ptr [rbp - 4]      #    return a@b;
0x13c1:	addss xmm0, dword ptr [rbp - 8]      
0x13c6:	pop rbp                              #@
0x13c7:	ret                                  
0x13c8:	endbr64                              #int substract(int a, int b)@
0x13cc:	push rbp                             
0x13cd:	mov rbp, rsp                         
0x13d0:	mov dword ptr [rbp - 4], edi         
0x13d3:	mov dword ptr [rbp - 8], esi         
0x13d6:	mov eax, dword ptr [rbp - 4]         #    return a@b;
0x13d9:	sub eax, dword ptr [rbp - 8]         
0x13dc:	pop rbp                              #@
0x13dd:	ret                                  
0x13de:	endbr64                              #float substractf(float a, float b)@
0x13e2:	push rbp                             
0x13e3:	mov rbp, rsp                         
0x13e6:	movss dword ptr [rbp - 4], xmm0      
0x13eb:	movss dword ptr [rbp - 8], xmm1      
0x13f0:	movss xmm0, dword ptr [rbp - 4]      #    return a@b;
0x13f5:	subss xmm0, dword ptr [rbp - 8]      
0x13fa:	pop rbp                              #@
0x13fb:	ret                                  
