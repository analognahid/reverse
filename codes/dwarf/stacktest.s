...
0x121e:	mov dword ptr [rbp - 0x18], 0xb      #    int |p|op =11;
...
0x1282:	xor eax, eax                         
0x1284:	mov qword ptr [rbp - 0x10], 0        #    stack *|s|tk = NULL;
0x128c:	lea rax, [rbp - 0x10]                #    |p|ush(7, &stk);
0x1290:	mov rsi, rax                         
0x1293:	mov edi, 7                           
0x1298:	call 0x11a9                          
0x129d:	mov esi, 2                           #    int temp = |a|dd(1,2);
0x12a2:	mov edi, 1                           
0x12a7:	call 0x13a7                          
0x12ac:	mov dword ptr [rbp - 0x14], eax      
0x12af:	lea rdx, [rbp - 0x10]                #    |p|ush(temp, &stk);
0x12b3:	mov eax, dword ptr [rbp - 0x14]      
0x12b6:	mov rsi, rdx                         
0x12b9:	mov edi, eax                         
0x12bb:	call 0x11a9                          
0x12c0:	lea rax, [rbp - 0x10]                #    |p|ush(9, &stk);
0x12c4:	mov rsi, rax                         
0x12c7:	mov edi, 9                           
0x12cc:	call 0x11a9                          
0x12d1:	lea rax, [rbp - 0x10]                #    |p|ush(12,&stk);
0x12d5:	mov rsi, rax                         
0x12d8:	mov edi, 0xc                         
0x12dd:	call 0x11a9                          
0x12e2:	lea rax, [rbp - 0x10]                #    |p|rintf("%d\n",pop(&stk));
0x12e6:	mov rdi, rax                         
0x12e9:	call 0x120e                          
0x12ee:	mov esi, eax                         
...
0x12fa:	mov eax, 0                           
0x12ff:	call 0x10a0                          
0x1304:	lea rax, [rbp - 0x10]                #    |p|rintf("%d\n",pop(&stk));
0x1308:	mov rdi, rax                         
0x130b:	call 0x120e                          
0x1310:	mov esi, eax                         
...
0x131c:	mov eax, 0                           
0x1321:	call 0x10a0                          
0x1326:	lea rax, [rbp - 0x10]                #    |p|rintf("%d\n",pop(&stk));
0x132a:	mov rdi, rax                         
0x132d:	call 0x120e                          
0x1332:	mov esi, eax                         
...
0x133e:	mov eax, 0                           
0x1343:	call 0x10a0                          
0x1348:	lea rax, [rbp - 0x10]                #    |p|rintf("%d\n",pop(&stk));
0x134c:	mov rdi, rax                         
0x134f:	call 0x120e                          
0x1354:	mov esi, eax                         
...
0x1360:	mov eax, 0                           
0x1365:	call 0x10a0                          
0x136a:	lea rax, [rbp - 0x10]                #    |p|rintf("%d\n",pop(&stk));
0x136e:	mov rdi, rax                         
0x1371:	call 0x120e                          
0x1376:	mov esi, eax                         
...
0x13f3:	jmp 0x1404                           #    |f|or (int i = 0; i<10;i++){
0x13f5:	mov dword ptr [rbp - 4], 0           #        int |f|ran = 0;
